...
def stream(hostname, url, out):
    ...
    while curr_playback_frame < last_frame:
        ...
        if segments_in_buffer > join_segments:  #handles transfer of frames to playback
            if not playing :
        ...
        if segments_in_buffer == 0:     #get initial segment of data
